...
public class DataValidator {
    ...
    public static boolean makeProject(String startDate, String projectName, double cost, String status, String description, Partner partner, String goal) throws ClassNotFoundException, SQLException
    {   
